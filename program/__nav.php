    ...
    <div class="p-0 sidebar-wrap transition">
        ...
        <div class="card border-0 sidebar">
            <div class="sidebar-logo d-flex justify-content-center ">
                <img src="/../resources/images/route-page-title2.svg" class="img-fluid">
            </div>
            ...
            <div class="links">
                <a href="" class="d-flex align-items-center transition"><i class="material-icons">group</i>概況</a>
                <a href="" class="d-flex align-items-center transition"><i class="material-icons">group</i>會員管理</a>
                ...
                <a href="event_list.php" class="d-flex align-items-center transition"><i class="material-icons">place</i>路線管理</a>
