...
if (!empty($_GET['keyword'])) {
    ...
    $t_sql = "SELECT * FROM `member` WHERE  m_sid LIKE ? OR m_mobile LIKE ? OR m_name LIKE ? OR m_email LIKE ? OR m_address LIKE ? OR m_active LIKE ? OR m_city LIKE ? OR m_town LIKE ?";
    $t_stmt = $pdo->prepare($t_sql);
    $str = "%" . $_GET['keyword'] . "%";
    $t_stmt->execute([
        $str,
...
if (!empty($_GET['keyword']) && !empty($_GET['city'])) {
    $t_sql = "SELECT * FROM `member` WHERE m_city LIKE ? AND (m_sid LIKE ? OR m_mobile LIKE ? OR m_name LIKE ? OR m_email LIKE ? OR m_address LIKE ? OR m_active LIKE ? OR m_city LIKE ? OR m_town LIKE ?)";
    $t_stmt = $pdo->prepare($t_sql);
    $str_c = "%" . $_GET['city'] . "%";
    $str = "%" . $_GET['keyword'] . "%";
    $t_stmt->execute([
